...
FORCE_INCLUDE =
ALL_CPPFLAGS = $(CPPFLAGS) /Zi /DNDEBUG /DEBUG:FULL /nologo /Od /MP $(DEFINES) $(INCLUDES) $(ALL_CPPFLAGS)
...
ALL_LDFLAGS = $(LDFLAGS)  /DEBUG /PDB:"$(TARGETDIR)\bake_lang_cpp.pdb" /LIBPATH:$(BAKE_HOME)\lib $(LIBS)
